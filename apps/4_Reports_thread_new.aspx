                        ...
                        <div class="box-body p-15">
                            ...
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Account Service" FieldName="WhatsAppNumber" Width="150px" Settings-AutoFilterCondition="Contains"></dx:GridViewDataTextColumn>
