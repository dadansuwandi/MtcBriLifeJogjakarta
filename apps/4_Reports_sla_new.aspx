                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><b>Report SLA</b></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="box-body p-15">
                            ...
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView" runat="server" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Date Eskalasi Layer 3" FieldName="DateEskalasiLayer3" Width="150px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Date Response Layer 3" FieldName="DateResponseLayer3" Width="150px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="SLA Response Layer 3" FieldName="SLAResponseTime" Width="150px"></dx:GridViewDataTextColumn>
