...
Public Class ServiceTaskboard
    ...
    Public Function InsertNoteInternal(ByVal TrxInternalNote As String, ByVal TrxTicketNumber As String, ByVal TrxUserName As String) As String
        ...
        'Dim TrxAutoID As String = DateTime.Now.ToString("yyyyMMddhhmmss")
        'Dim TrxEmailID = TrxAutoID & New Random().Next(1000000, 9999999)
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                'sqlComm.Parameters.AddWithValue("TrxLoginAngka", TrxLoginAngka)
                con.Open()
