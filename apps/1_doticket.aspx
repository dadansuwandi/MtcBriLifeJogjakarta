                                    ...
                                    <div id="navpills-2" class="tab-pane active">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="datetime-local" id="Ticket_DateofTransaction" onkeydown='return false'>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Polis Number</label>
                                                    <input class="form-control" type="text" id="Ticket_BankAccount" placeholder="Polis Number">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Problem</label><span class="badge badge-pill badge-primary float-right" style="font-weight: bold; font-size: 12px;" id="Ticket_SLA"><i class="fa fa-clock-o"></i>&nbsp;0 Days</span>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer modal-footer-uniform">
                    ...
                    <a class="btn btn-rounded btn-primary float-right" href="#" data-toggle="modal" data-target="#modal-center" onclick="showAddCustomer()">Add</a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="col-md-4">
                             ...
                             <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="cusTomerFacebook" placeholder="Facebook Account">
                                </div>
                            </div>
                        </div>
                        <div class="row">                           
