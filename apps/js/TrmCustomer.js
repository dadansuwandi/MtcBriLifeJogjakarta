$(document).ready(function () {
    ...
    if (getParameterByName("id") != "") {
        selectedCustomer(getParameterByName("id"))
        $("#ContentPlaceHolder1_TrxCustomerID").val(getParameterByName("id"))
    }
});
        ...
        .then((willDelete) => {
            if (willDelete) {
                var form_data = JSON.stringify({
                    ...
                    TrxCusTomerAlamat: encodeData(TrxCusTomerAlamat), TrxNumberID: "0", TrxFacebook: TrxFacebook, TrxInstagram: TrxInstagram, TrxTwitter: TrxTwitter
                });
...
function UpdateProfile() {
    ...
    var TrxFacebook = $("#Facebook_Account").val();
