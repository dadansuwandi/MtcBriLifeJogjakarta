        ...
        success: function (data) {
            ...
            for (i = 0; i < json.length; i++) {
                ...
                if (json[i].ValueThread == "Outbound Call") {
                    ...
                    var FileHTML = "http://10.28.2.222/brilifecc/FileEmail/INBOX/" + json[i].ThreadID + "/file.html"
                    var IconChannel = json[i].ValueThread
                    var IconChannelSosialMedia = ""
                } else if (json[i].ValueThread == "Whatsapp") {
                    var FileHTML = "http://10.28.2.222/brilifecc/apps/template/wa.html?convid=" + json[i].GenesysNumber + ""
                    var IconChannel = json[i].ValueThread
                    var FileHTMLSosialMedia = "http://10.28.2.222/brilifecc/apps/template/socialmedia.html?convid=" + json[i].GenesysNumber + ""
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (i = 0; i < json.length; i++) {
                ...
                if (json[i].DispatchTypeName == null || json[i].DispatchTypeName == "") {
