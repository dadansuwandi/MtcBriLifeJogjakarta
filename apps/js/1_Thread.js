        ...
        success: function (data) {
            ...
            if (json.length == 0) {
                ...
                for (i = 0; i < json.length; i++) {
                    ...
                    myTable.row.add([CustomerID, json[i].GenesysNumber, TrxIcon, CustomerName, AccountEmail, CustomerSubject, TrxAgent, EmailDate, ConverTanggal, urlClick]).draw(false);
