...
Public Class WebServiceGetDataMaster
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function UpdateTransactionTrmProductType(ByVal TrxID As String, ByVal TrxUserName As String, ByVal TrxName As String, ByVal TrxStatus As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Valuenya As String = String.Empty
        Dim _Result As String = String.Empty
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxProductType '" & TrxID & "','" & TrxUserName & "','" & AntiXssEncoder.HtmlEncode(TrxName.Trim, True) & "','" & TrxStatus & "'"
            LogError(strLogTime, ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
    ...
    Public Function InsertTransactionUserApplication(ByVal TrxUserName As String, ByVal TrxName As String, ByVal TrxEmail As String, ByVal TrxPassword As String,
                                                     ...
                                                     ByVal TrxChannelTwitter As String, ByVal TrxChannelWalkin As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Valuenya As String = String.Empty
        Dim _Result As String = String.Empty
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function InsertNotificationTemplate(ByVal TrxUserName As String, ByVal TrxSubject As String, ByVal TrxBody As String, ByVal TrxAccount As String,
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.Parameters.AddWithValue("TrxAccount", HttpUtility.UrlDecode(TrxAccount))
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxNotificationTemplate '0','" & UserNameXSS & "','" & HttpUtility.UrlDecode(TrxSubject) & "','" & HttpUtility.UrlDecode(TrxBody) & "','" & HttpUtility.UrlDecode(TrxAccount) & "','" & HttpUtility.UrlDecode(TrxFooter) & "','" & TrxType & "','" & TrxStatus & "','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function UpdateNotificationTemplate(ByVal TrxID As String, ByVal TrxUserName As String, ByVal TrxSubject As String, ByVal TrxBody As String, ByVal TrxAccount As String,
                                              ByVal TrxFooter As String, ByVal TrxType As String, ByVal TrxStatus As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Valuenya As String = String.Empty
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxNotificationTemplate '" & TrxID & "','" & UserNameXSS & "','" & HttpUtility.UrlDecode(TrxSubject) & "','" & HttpUtility.UrlDecode(TrxBody) & "','" & HttpUtility.UrlDecode(TrxAccount) & "','" & HttpUtility.UrlDecode(TrxFooter) & "','" & TrxType & "','" & TrxStatus & "','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
    ...
    Public Function DeleteNotificationTemplate(ByVal TrxID As String, ByVal TrxUserName As String) As String
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.Parameters.AddWithValue("TrxAccount", "0")
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxNotificationTemplate '" & TrxID & "','" & UserNameXSS & "','0','0','0','0','0','0','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
