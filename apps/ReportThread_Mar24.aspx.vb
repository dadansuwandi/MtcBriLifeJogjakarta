...
Public Class ReportThread_Mar24
    ...
    Private Sub btn_Submit_Click(sender As Object, e As EventArgs) Handles btn_Submit.Click
        Dim queryInsert As String = "exec [SP_2024_ReportThread] '" & Session("UserName") & "','" & Format(dt_strdate.Value, "yyyy-MM-dd") & "','" & Format(dt_endate.Value, "yyyy-MM-dd") & "','" & CmbChannel.Value & "','INSERT'"
        ...
        Catch ex As Exception
            Response.Write(DirectCast(ex.Message() & "_exec [SP_2024_ReportThread] '" & Session("UserName") & "','" & Format(dt_strdate.Value, "yyyy-MM-dd") & "','" & Format(dt_endate.Value, "yyyy-MM-dd") & "','" & CmbChannel.Value & "','INSERT'", String))
        End Try
        ASPxGridView1.DataBind()
    End Sub
    Private Sub ASPxGridView1_Init(sender As Object, e As EventArgs) Handles ASPxGridView1.Init
        tempTrxThread.SelectCommand = "exec [SP_2024_ReportThread] '" & Session("UserName") & "','2024-03-30','2024-03-30','All','SELECT'"
