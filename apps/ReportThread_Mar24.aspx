<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/apps/Uidesk.Master" CodeBehind="ReportThread_Mar24.aspx.vb" Inherits="ICC.ReportThread_Mar24" %>
                        ...
                        <div class="box-body p-15">
                            ...
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Agent Name" FieldName="AgentIDNew" Width="150px" Settings-AutoFilterCondition="Contains"></dx:GridViewDataTextColumn>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Subject" FieldName="Subject" Width="250px" Settings-AutoFilterCondition="Contains"></dx:GridViewDataTextColumn>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Reason Type" FieldName="ThreadReasonNonHtml" Width="250px" Settings-AutoFilterCondition="Contains"></dx:GridViewDataTextColumn>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Account Service" FieldName="WhatsAppNumber" Width="250px" Settings-AutoFilterCondition="Contains"></dx:GridViewDataTextColumn>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Date Agent Received" FieldName="DateBlending" Width="150px" Settings-AutoFilterCondition="Contains"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Date Solving" FieldName="Datesolving" Width="150px" Settings-AutoFilterCondition="Contains"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="SLA Response Time" FieldName="SLAResponseTime" Width="150px" Settings-AutoFilterCondition="Contains"></dx:GridViewDataTextColumn>
                                </Columns>
                            </dx:ASPxGridView>
                        </div>
                    </div>
