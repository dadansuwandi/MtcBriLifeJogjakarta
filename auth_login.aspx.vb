...
Public Class auth_login
    ...
    Dim VariabelCookiesEncriptions As New HttpCookie("CookiesVariabel")
    ...
    Private Sub auth_login_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Request.QueryString("usdesk") <> "" And Request.QueryString("epic") = "1" Then
            Login_Username.Value = Request.QueryString("usdesk")
    ...
    Function AccessLogin3CX(ByVal username As String)
        ...
        Try
            _uplogin = "UPDATE MSUSER SET LOGIN='1', IdAUX='9', DescAUX='READY', AUTHORITY='" & RandomString(Request.QueryString("user")) & "' WHERE USERNAME ='" & username & "'"
        ...
        If Request.QueryString("") <> "" Then
            _uplogin = "UPDATE MSUSER SET LOGIN='1',IdAUX='9',DescAUX='READY', AUTHORITY='" & RandomString(Request.QueryString("user")) & "' WHERE USERNAME ='" & Request.QueryString("user") & "'"
    ...
    Function AccessLogin(ByVal UserName As String, ByVal Password As String)
        ...
        Try
            ...
            If sqldr.HasRows Then
                ...
                VariabelCookiesEncriptions.Values("CookiesVariabel") = sqldr("AUTHORITY").ToString
                VariabelCookiesEncriptions.Expires = DateTime.Now.AddDays(AddCookiess)
                Response.Cookies.Add(VariabelCookiesEncriptions)
    ...
    Private Sub CheckLicense()
        Dim strLicensed As String = String.Empty
        strLicensed = "EXEC [SP_INV_CHECK_LIC_SUM]  '" & Login_Username.Value & "','UideskIndonesia','BRILife','2021-12-15','2030-12-15'"
        Try
            readerlic = Proses.ExecuteReader(strLicensed)
